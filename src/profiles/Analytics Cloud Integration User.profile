...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <layoutAssignments>
        <layout>Enhancement_Request__c-Enhancement Request Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>MaskField__c-MaskField Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>MaskObject__c-MaskObject Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>forgot_tabs__c-forgot tab Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
